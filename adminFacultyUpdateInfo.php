 ...
 if(isset($_POST['registerButton']))
{
	...
	if($result)
	{
		$query="UPDATE faculty set education='$education', name='$name', department='$department', password='$password', picture='$dir' where userName='$userName'";
...
<div style="background-color: #1a1a1a;" class="super_container">
	...
	<!-- Home//////////////////////////// #1a1a1a;-->
	<div style="height: 700px; background-color: #1a1a1a; margin-top: 230px;">
    ...
    <p class="h4 mb-4">Update Faculty Record</p>

        <p style="color: #ff6666;" class="h4 mb-4"><u>User Name:</u> <?php echo $_GET['userName']?> </p>


     <input style="width: 500px; margin-left: 400px;" name="name" type="name" class="form-control mb-4" placeholder="Faculty Name">
