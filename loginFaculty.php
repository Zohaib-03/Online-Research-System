...
if(isset($_POST['login']))
{
	...
	$query="SELECT *FROM faculty WHERE userName='$userName' && password='$password'";
	...
	header('location:loginFacultyAfter.php');
	 ...
	 {
$message = "check user name or password and contact to admin";
...
<div style="background-color: #1a1a1a;" class="super_container">
		...
		<div class="header_content d-flex flex-row align-items-center">
			...
			<div class="logo_container">
				<div class="logo">
					...
					<span style="margin-left: 20px;">Faculty</span>
				</div>
			</div>
    ...
    <!-- Register -->
    <p>Not a member?
        <a href="registerFaculty.php">Register</a>
    </p>
