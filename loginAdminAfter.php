...
?>
						...
						<tbody>
								<tr>
									...
									<td><button class="btn-danger btn" ><a style="color: white;" href="adminStudentUpdate.php?rollNumber=<?php echo $res['rollNumber'];?>"><?php echo $res['status'];?></a></button></td>

									<td><button class="btn-danger btn" ><a style="color: white;" href="adminStudentUpdateInfo.php?rollNumber=<?php echo $res['rollNumber'];?>">Update</a></button></td>

									<td><button class="btn-danger btn" ><a style="color: white;" href="adminStudentDelete.php?rollNumber=<?php echo $res['rollNumber'];?>">Delete</a></button></td>
