...
{
	$userName1=$_POST['rollNumber'];
 	$query1="SELECT *FROM student WHERE rollNumber='$userName1'";
...
echo "<script>alert('$message');</script>";
	...
	if($result)
	{
		$query="insert into student(name,rollNumber,department,password,status,picture,supervise,supervisorUserName) VALUES ('$name','$rollNumber','$department','$password','pending','$dir','no supervisor','no supervisor')";
...
<div style="background-color: #1a1a1a;" class="super_container">
		...
		<div class="header_content d-flex flex-row align-items-center">
			...
			<div class="logo_container">
				<div class="logo">
					...
					<span style="margin-left: 20px;">Student Registration</span>
				</div>
			</div>
	...
	<!-- Home//////////////////////////// #1a1a1a;-->
	<div style="height: 600px; background-color: #1a1a1a; margin-top: 180px;">
